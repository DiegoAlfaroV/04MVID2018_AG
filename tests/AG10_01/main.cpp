...
int main(int argc, char* argv[]) {
	...
	uint32_t text1 = createTexture("../tests/AG10_01/albedo.png");
	uint32_t text2 = createTexture("../tests/AG10_01/specular.png");
	...
	while (!glfwWindowShouldClose(window)) {
		...
		render(lightingShader, cubeVAO, quadVAO, text1, text2);
